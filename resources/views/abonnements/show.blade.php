            ...
            <div style="margin-bottom: 2rem;">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li style="padding: 0.75rem 0; border-bottom: 1px solid #dee2e6;">
                        ...
                        <span
                            style="color: #666; margin-left: 0.5rem;">{{ number_format($abonnement->commission, 2, ',', ' ') }}%</span>
                    </li>
                    ...
                    @if(auth()->user()->estVendeur() && auth()->user()->vendeur && auth()->user()->vendeur->estVerifie())
                        <form method="POST" action="{{ route('abonnements.subscribe') }}"
                            ...
                            <div style="margin-bottom: 1rem;">
                                <label style="display: block; color: #333; margin-bottom: 0.5rem; font-weight: 500;">Durée (en mois)
                                    :</label>
                                <select name="duree_mois" required
                            ...
                            <button type="submit"
                                style="width: 100%; background: #EF3B2D; color: white; border: none; padding: 0.75rem; border-radius: 4px; font-size: 1rem; font-weight: 500; cursor: pointer;">
