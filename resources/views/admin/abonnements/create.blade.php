                        ...
                        <div style="display: grid; gap: 1.25rem;">
                            <div>
                                ...
                                <div class="custom-select-container" id="type-select">
                                    @php $firstAvailable = reset($availableTypes); @endphp
                                    <input type="hidden" name="type" id="type-value" value="{{ old('type', $firstAvailable) }}">
                                    <div class="custom-select-trigger">
                                        <span id="type-label">{{ $firstAvailable ? ucfirst(old('type', $firstAvailable)) : 'Aucun type disponible' }}</span>
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3" required
                                    ...
                                    onfocus="this.style.borderColor='#e67e00'" onblur="this.style.borderColor='#e0e0e0'">{{ old('description') }}</textarea>
