...
@section('content')
    <div style="max-width: 1000px;">
        ...
        <header style="margin-bottom: 1.5rem;">
            ...
            <p style="font-size: 0.95rem; color: #666; font-weight: 400;">Configurez les paramètres du pack d'abonnement pour les vendeurs.</p>
        </header>
                        ...
                        <div style="display: grid; gap: 1.25rem;">
                            <div>
                                ...
                                <select name="type" id="type" required 
                                    ...
                                    <option value="gratuit" {{ old('type') == 'gratuit' ? 'selected' : '' }}>Gratuit</option>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 1.5rem;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem;">
                            ...
                            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                                <input type="checkbox" name="page_pro" value="1" {{ old('page_pro') ? 'checked' : '' }} style="width: 18px; height: 18px;">
