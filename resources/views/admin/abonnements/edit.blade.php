        ...
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eff3f6; padding-bottom: 15px; margin-bottom: 24px;">
            <div style="display: flex; align-items: center; gap: 12px;">
                <div style="display: flex; align-items: center; gap: 8px; color: #475569; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; height: 28px;">
                    ...
                    <span style="line-height: 1;">Modifier le Pack : {{ ucfirst($abonnement->nom) }}</span>
                </div>
            </div>
                ...
                <div class="amazon-card" style="margin: 0;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <select name="type" id="type" required>
                            <option value="gratuit" data-ecommerce="1" {{ old('type', $abonnement->type) === 'gratuit' ? 'selected' : '' }}>Gratuit</option>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="description" id="description" rows="10" required
                            ...
                            style="resize: vertical; font-family: inherit;">{{ old('description', $abonnement->description) }}</textarea>
                    ...
                    <div style="flex: 1;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="number" name="limite_chiffre_affaires" id="limite_chiffre_affaires"
                                   value="{{ old('limite_chiffre_affaires', $abonnement->limite_chiffre_affaires) }}"
