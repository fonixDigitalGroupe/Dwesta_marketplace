    ...
    <div style="max-width: 100%;">
        ...
        <div style="background: #fff; border: 1px solid #eee; border-radius: 2px; padding: 1.5rem;">
            ...
            <div style="margin-bottom: 0.5rem;">
                <h1 style="font-size: 1.25rem; font-weight: 700; color: #333; margin: 0;">Modifier le Pack : {{ ucfirst($abonnement->nom) }}</h1>
            </div>
                    ...
                    <div style="display: grid; gap: 1.5rem;">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="6" required
                                ...
                                oninput="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)">{{ old('description', $abonnement->description) }}</textarea>
