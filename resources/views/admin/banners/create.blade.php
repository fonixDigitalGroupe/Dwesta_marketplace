                    ...
                    <div class="amazon-card" style="margin: 0;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 15px;">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Ex: Promo d'été 2025">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div class="amazon-card" style="margin: 0;">
                            ...
                            <div class="dropzone-amazon" onclick="document.getElementById('image-input').click()">
                                ...
                                <img id="preview-img" style="display: none; max-width: 100%; max-height: 120px; object-fit: contain;">
                            </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 15px;">
                            ...
                            <div style="border-top: 1px solid #f1f5f9; padding-top: 15px;">
                                <label class="checkbox-container">
                                    ...
                                    <span style="font-size: 0.75rem; font-weight: 700; color: #475569; text-transform: uppercase; letter-spacing: 0.05em;">Activer maintenant</span>
                                </label>
                            </div>
                        </div>
