...
<div style="max-width: 100%;">
    ...
    <div style="background: #fff; border: 1px solid #eee; border-radius: 2px; padding: 1.5rem;">
        ...
        <div style="margin-bottom: 0.5rem;">
            <h1 style="font-size: 1.25rem; font-weight: 700; color: #333; margin: 0;">Modifier la Bannière</h1>
        </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 340px; gap: 2rem; align-items: start;">
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div style="background: #fdfdfd; border: 1px solid #f3f3f3; border-radius: 4px; padding: 1.5rem;">
                        ...
                        <div style="border: 2px dashed #e2e8f0; border-radius: 8px; padding: 2.5rem; text-align: center; background: #f8fafc; cursor: pointer; position: relative;" 
                             onclick="document.getElementById('image-input').click()">
                            
                            <img id="preview-img" src="{{ $banner->image_url }}" style="max-width: 100%; max-height: 250px; object-fit: contain; border-radius: 4px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                            
                            <div style="margin-top: 1rem; color: #64748b; font-size: 0.85rem; font-weight: 500;">
                                <i class="fas fa-sync" style="margin-right: 4px;"></i> Cliquez pour changer l'image
                            </div>
                        </div>
