                    ...
                    <div style="display: flex; flex-direction: column; gap: 20px;">
                        ...
                        <div style="border-top: 1px solid #eee; padding-top: 20px;">
                            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                                <input type="checkbox" name="is_promo" id="is_promo" value="1" {{ old('is_promo', $banner->is_promo) ? 'checked' : '' }} 
                            ...
                            <div id="promo-categories-section" style="{{ old('is_promo', $banner->is_promo) ? 'display: block;' : 'display: none;' }} background: #fcfcfc; border: 1px solid #eee; padding: 15px; border-radius: 4px;">
