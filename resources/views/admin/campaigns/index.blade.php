...
<div style="max-width: 1100px; margin: 0 auto; padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
        ...
        <a href="{{ route('campaigns.create') }}" class="btn btn-primary" style="background: linear-gradient(180deg, #ff9900 0%, #e77600 100%); border: 1px solid #a88734; color: #111; font-weight: 600;">
