...
@section('breadcrumbs')
    ...
    <span style="color: #bf0000; font-weight: 500;">Édition</span>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleFamille() {
                if (parentSelect.value === "") {
                    ...
                    // familleSelect.setAttribute('required', 'required'); // Optional in edit if already set? Better to keep forced.
                } else {
...
@section('content')
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <header style="margin-bottom: 1.5rem;">
            <h1 style="font-size: 1.5rem; color: #333; font-weight: 500; margin-bottom: 0.25rem;">Modifier la catégorie</h1>
            <p style="font-size: 0.95rem; color: #666; font-weight: 400;">Mise à jour de la configuration de :
            ...
            <div style="display: grid; grid-template-columns: 1fr 340px; gap: 2rem; align-items: start;">
                        ...
                        <div style="display: grid; gap: 1.25rem;">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="4"
                                    ...
                                    onblur="this.style.borderColor='#e0e0e0'">{{ old('description', $category->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 1.5rem;">
                        ...
                        <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 1.5rem;">
                            <h3 style="font-size: 1rem; color: #333; font-weight: 500; margin-bottom: 1.25rem;">Visuel &
                                État
                            </h3>
                                ...
                                <div>
                                    ...
                                    <div style="padding-top: 1rem; border-top: 1px solid #f0f0f0; margin-top: 1rem;">
                                        <label for="actif"
                                            ...
                                            <input type="checkbox" name="actif" id="actif" value="1" {{ (old('_token') ? old('actif') : $category->actif) ? 'checked' : '' }}
