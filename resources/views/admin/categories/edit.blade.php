                                ...
                                <div style="display: grid; gap: 1rem; margin-top: 1rem;">
                                    <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; user-select: none;">
                                        <div style="position: relative; width: 20px; height: 20px;">
                                            ...
                                            <div id="custom-checkbox-actif" style="position: absolute; top: 0; left: 0; height: 20px; width: 20px; background-color: {{ (old('_token') ? old('actif') : $category->actif) ? '#999' : '#eee' }}; border-radius: 4px; display: flex; align-items: center; justify-content: center; transition: all 0.2s;">
                                                <i class="fas fa-check" style="color: #fff; font-size: 10px; opacity: {{ (old('_token') ? old('actif') : $category->actif) ? '1' : '0' }};"></i>
                                            </div>
                                        </div>
