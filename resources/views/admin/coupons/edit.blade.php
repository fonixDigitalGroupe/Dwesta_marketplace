                    ...
                    <div class="amazon-card" style="margin: 0;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 15px;">
                            <div>
                                ...
                                <input type="datetime-local" name="start_date" id="start_date" value="{{ old('start_date', $coupon->start_date ? $coupon->start_date->format('Y-m-d\TH:i') : '') }}">
                            </div>

                            <div>
                                <label for="end_date" class="field-label">Date de fin</label>
                                <input type="datetime-local" name="end_date" id="end_date" value="{{ old('end_date', $coupon->end_date ? $coupon->end_date->format('Y-m-d\TH:i') : '') }}">
                            </div>

                            <div style="border-top: 1px solid #f1f5f9; padding-top: 15px;">
                                <label for="usage_limit" class="field-label">Limite d'utilisation globale</label>
                                <input type="number" min="1" name="usage_limit" id="usage_limit" value="{{ old('usage_limit', $coupon->usage_limit) }}" placeholder="Ex: 100">
                                <p style="font-size: 0.7rem; color: #94a3b8; margin-top: 5px;">Utilisé <strong>{{ $coupon->used_count }}</strong> fois.</p>
                            </div>
