...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h1 style="font-size: 1.25rem; font-weight: 500; color: #111; margin: 0;">Modifier le pack : {{ $pack->nom }}</h1>
            ...
            <div class="amazon-card">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea name="description" id="description" rows="5"
                        style="width: 100%; padding: 8px 12px; border: 1px solid #adb1b8; border-radius: 0; font-size: 0.85rem; outline: none; background: #fcfcfc; resize: vertical; font-family: inherit;">{{ old('description', $pack->description) }}</textarea>
