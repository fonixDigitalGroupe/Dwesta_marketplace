...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h1 style="font-size: 1.25rem; font-weight: 500; color: #111; margin: 0;">Ajouter un service</h1>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div class="amazon-card" style="margin-bottom: 0;">
                    ...
                    <div style="display: grid; gap: 20px;">
                        <div>
                            <label for="cle" style="display: block; font-size: 0.85rem; font-weight: 700; color: #111; margin-bottom: 8px;">
                                Type de service (Clé technique) <small style="color: red;">*</small>
                            </label>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                style="width: 100%; padding: 8px 12px; border: 1px solid #adb1b8; border-radius: 0; font-size: 0.85rem; color: #111; outline: none; background: #fcfcfc; resize: vertical;">{{ old('description') }}</textarea>
