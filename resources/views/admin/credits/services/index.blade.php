                    ...
                    @forelse($services as $service)
                        <tr style="border-bottom: 1px solid #e7e7e7; transition: background 0.1s;"
                            ...
                            <td style="padding: 12px 15px; text-align: center; border-right: 1px solid #e7e7e7;">
                                <span
                                    style="font-size: 0.85rem; font-weight: 600; color: #111;">{{ $service->credits_requis }}</span>
                            </td>
                            <td style="padding: 12px 15px; text-align: center; border-right: 1px solid #e7e7e7;">
                            ...
                            <td style="padding: 12px 15px; text-align: right;">
                                <div style="display: flex; gap: 10px; justify-content: flex-end; align-items: center;">
                                    <a href="{{ route('admin.credits.services.edit', $service) }}" title="Modifier"
                                    ...
                                    <form id="delete-form-{{ $service->id }}"
                                        action="{{ route('admin.credits.services.destroy', $service) }}" method="POST"
