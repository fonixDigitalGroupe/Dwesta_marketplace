                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem; margin-bottom: 1.5rem;">
                            ...
                            <div>
                                ...
                                <select id="l2_category_id" {{ !$l2Id ? 'disabled' : '' }}
                                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 0.9rem; outline: none; background: {{ $l2Id ? '#fff' : '#fdfdfd' }}; cursor: {{ $l2Id ? 'pointer' : 'not-allowed' }};">
                                    <option value="">-- Choisir --</option>
                                    @if($l2Id)
                            ...
                            <div>
                                ...
                                <select name="category_id" id="category_id" required {{ !$l3Id ? 'disabled' : '' }}
                                    style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-size: 0.9rem; outline: none; background: {{ $l3Id ? '#fff' : '#fdfdfd' }}; cursor: {{ $l3Id ? 'pointer' : 'not-allowed' }};">
                                    <option value="">-- Choisir --</option>
                                    @if($l3Id)
                        ...
                        <div style="display: grid; gap: 1rem;">
                            <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; user-select: none;">
                                <div style="position: relative; width: 20px; height: 20px;">
                                    <input type="checkbox" name="is_filterable" value="1" {{ $filter->is_filterable ? 'checked' : '' }} id="checkbox-is-filterable"
                                        style="position: absolute; opacity: 0; cursor: pointer; height: 0; width: 0;">
                                    <div id="custom-checkbox" style="position: absolute; top: 0; left: 0; height: 20px; width: 20px; background-color: {{ $filter->is_filterable ? '#999' : '#eee' }}; border-radius: 4px; display: flex; align-items: center; justify-content: center; transition: all 0.2s;">
                                        <i class="fas fa-check" style="color: #fff; font-size: 10px; opacity: {{ $filter->is_filterable ? '1' : '0' }};"></i>
                                    </div>
                                </div>
