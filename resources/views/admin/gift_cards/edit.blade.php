...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h1 style="font-size: 1.25rem; font-weight: 500; color: #111; margin: 0;">Modifier l'option de Carte Cadeau</h1>
    ...
    <form action="{{ route('admin.gift_cards.update', $giftCardOption) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; align-items: stretch;">
            ...
            <div class="amazon-card">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="number" name="amount" id="amount" value="{{ old('amount', $giftCardOption->amount) }}" class="form-control-amazon" min="1" placeholder="Ex: 5000" required>
                ...
                <div>
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description', $giftCardOption->description) }}" class="form-control-amazon" placeholder="Ex: Idéal pour un petit cadeau">
            ...
            <div class="amazon-card">
                ...
                <div style="margin-bottom: 25px;">
                    <label class="checkbox-container">
                        <input type="checkbox" name="is_popular" id="is_popular" value="1" {{ old('is_popular', $giftCardOption->is_popular) ? 'checked' : '' }}>
                ...
                <div>
                    <label class="checkbox-container">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $giftCardOption->is_active) ? 'checked' : '' }}>
                        <span class="checkmark"></span>
                        <div style="display: flex; flex-direction: column; gap: 2px;">
                ...
                <div style="margin-top: 30px; background-color: #e7f3fe; border: 1px solid #b3d7ff; padding: 15px; color: #004085; font-size: 0.8rem;">
                    <i class="fas fa-history" style="margin-right: 8px;"></i> Dernière mise à jour le {{ $giftCardOption->updated_at->format('d/m/Y à H:i') }}
                </div>
            </div>
        </div>
