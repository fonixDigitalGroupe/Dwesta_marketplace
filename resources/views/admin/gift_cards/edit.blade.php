            ...
            <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eff3f6; padding-bottom: 15px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <div style="display: flex; align-items: center; gap: 8px; color: #475569; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; height: 28px;">
                        ...
                        <span style="line-height: 1;">Modifier l'option de Carte Cadeau</span>
                    </div>
                </div>
                    ...
                    <div class="amazon-card" style="margin: 0;">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="number" name="amount" id="amount"
                                value="{{ old('amount', $giftCardOption->amount) }}" min="1" placeholder="Ex: 5000"
                                required>
                        ...
                        <div>
                            ...
                            <input type="text" name="description" id="description"
                                value="{{ old('description', $giftCardOption->description ? ucfirst($giftCardOption->description) : '') }}"
                        ...
                        <div style="margin-bottom: 25px;">
                            <label class="checkbox-container">
                                <input type="checkbox" name="is_popular" id="is_popular" value="1"
                                    {{ old('is_popular', $giftCardOption->is_popular) ? 'checked' : '' }}>
                        ...
                        <div style="margin-bottom: 25px;">
                            <label class="checkbox-container">
                                <input type="checkbox" name="is_active" id="is_active" value="1"
                                    {{ old('is_active', $giftCardOption->is_active) ? 'checked' : '' }}>
                                <span class="checkmark"></span>
                                <div style="display: flex; flex-direction: column; gap: 2px;">
