...
@section('breadcrumbs')
    ...
    <span style="color: #333; font-weight: 500;">Nouvel onglet</span>
@endsection
...
@section('content')
    <div style="max-width: 1000px; margin: 0 auto;">
        ...
        <header style="margin-bottom: 1.5rem; display: flex; justify-content: space-between; align-items: flex-start;">
            <div>
                <h1 style="font-size: 1.5rem; color: #333; font-weight: 500; margin-bottom: 0.25rem;">Ajouter un onglet</h1>
                <p style="font-size: 0.95rem; color: #666; font-weight: 400;">Configurez une nouvelle catégorie pour la grille Bento.</p>
            </div>
                    ...
                    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 1.5rem;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1.25rem;">
                            ...
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <input type="checkbox" name="active" id="active" value="1" {{ old('active', true) ? 'checked' : '' }} style="cursor: pointer;">
