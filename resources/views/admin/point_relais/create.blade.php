                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div class="amazon-card" style="margin: 0;">
                        ...
                        <div style="margin-bottom: 0;">
                            ...
                            <input type="tel" name="telephone" id="telephone" value="{{ old('telephone') }}" placeholder="7x xx xx xx">
                    ...
                    <div class="amazon-card" style="margin: 0;">
                        ...
                        <div style="margin-bottom: 0;">
                            ...
                            <textarea name="adresse" id="adresse" rows="3" required
                                      ...
                                      oninput="if(this.value) this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1)">{{ old('adresse') }}</textarea>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const updateRegions = (country) => {
            ...
            if (regions.length === 0) {
                const opt = document.createElement('option');
                opt.value = "Autre"; opt.textContent = "Autre...";
                regionSelect.appendChild(opt);
            }
        };
