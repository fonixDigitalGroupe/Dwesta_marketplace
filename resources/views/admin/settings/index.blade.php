...
@section('content')
    ...
    <div x-data="{ 
        ...
        <!-- Main Conteneur Blanc -->
        <div style="background: #fff; border: 1px solid #eee; border-radius: 2px; padding: 1.5rem;">
            
            <div style="margin-bottom: 0.5rem;">
                <h1 style="font-size: 1.25rem; font-weight: 700; color: #333; margin: 0;">Configuration Générale</h1>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 340px; gap: 2rem; align-items: start;">
                            ...
                            <div style="background: #fcfcfc; border: 1px solid #f0f0f0; border-radius: 12px; padding: 1.5rem;">
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 2rem;">
                                    ...
                                    <div style="flex-grow: 1; padding-top: 0.5rem;">
                                        <h4 style="font-size: 0.95rem; color: #333; font-weight: 600; margin-bottom: 0.25rem;">Image de marque</h4>
                                        <p style="font-size: 0.85rem; color: #777; margin-bottom: 1rem; line-height: 1.5;">Format recommandé (PNG, SVG, JPG).</p>
                                        
                                        <div style="display: flex; gap: 0.75rem;">
                                            <button type="button" @click="$refs.logoInput.click()" style="padding: 10px 40px; min-width: 220px; background: #e67e00; color: #fff; border: none; border-radius: 6px; font-size: 0.85rem; font-weight: 500; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                                ...
                                <div>
                                    ...
                                    <template x-for="(email, index) in emails" :key="index">
                                        <div style="display: flex; gap: 0.5rem; margin-bottom: 0.5rem; align-items: center;">
                                            ...
                                            <button type="button" @click="addEmail" x-show="index === emails.length - 1" style="width: 28px; height: 28px; background: #e67e00; color: #fff; border: none; border-radius: 6px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s; flex-shrink: 0;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'" title="Ajouter un email">
                                ...
                                <div id="phone-inputs-container">
                                    ...
                                    <template x-for="(phone, index) in phones" :key="index">
                                        <div style="display: flex; gap: 0.5rem; margin-bottom: 0.5rem; align-items: center;">
                                            ...
                                            <!-- Bouton Ajouter à droite (uniquement sur le dernier) -->
                                            <button type="button" @click="addPhone" x-show="index === phones.length - 1" style="width: 28px; height: 28px; background: #e67e00; color: #fff; border: none; border-radius: 6px; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.2s; flex-shrink: 0;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'" title="Ajouter un téléphone">
                                                <i class="fas fa-plus" style="font-size: 0.8rem;"></i>
                                            </button>
                                        </div>
                                    </template>
                        ...
                        <div style="display: flex; gap: 10px; margin-top: 0.5rem;">
                            <a href="{{ route('admin.dashboard') }}" style="flex: 1; display: flex; justify-content: center; padding: 12px; background: #dc2626; border: none; border-radius: 6px; color: #fff; text-decoration: none; font-weight: 500; font-size: 0.95rem; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='1'">
                                Annuler
                            </a>
