                            ...
                            <div>
                                ...
                                <div style="display: flex; gap: 20px;">
                                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.95rem; color: #333;">
                                        <input type="radio" name="civilite" value="M." {{ old('civilite') == 'M.' ? 'checked' : '' }} style="accent-color: #ff750f; width: 18px; height: 18px;">
                                        M.
                                    </label>
                                    <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 0.95rem; color: #333;">
                                        <input type="radio" name="civilite" value="Mme" {{ old('civilite') == 'Mme' ? 'checked' : '' }} style="accent-color: #ff750f; width: 18px; height: 18px;">
                                        Mme
                                    </label>
                                </div>
                                @error('civilite') <span style="color: #dc3545; font-size: 0.8rem; margin-top: 4px;">{{ $message }}</span> @enderror
                            </div>
