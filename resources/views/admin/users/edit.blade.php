                    ...
                    <div style="background: #fff; border: 1px solid #eee; border-radius: 2px; padding: 1.5rem;">
                        ...
                        <div>
                            ...
                            <textarea name="adresse" id="adresse" rows="2"
                                ...
                                onfocus="this.style.borderColor='#e67e00'" onblur="this.style.borderColor='#e0e0e0'">{{ old('adresse', $user->adresse) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    <div style="background: #fff; border: 1px solid #eee; border-radius: 2px; padding: 1.5rem;">
                        ...
                        <div style="margin-bottom: 1rem;">
                            ...
                            <label for="password" style="display: block; font-size: 0.85rem; font-weight: 600; color: #555; margin-bottom: 8px;">Nouveau mot de passe</label>
