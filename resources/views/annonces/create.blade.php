...
<body>
        ...
        <main class="form-content">
            <form id="createAnnonceForm" method="POST" action="{{ route('annonces.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-step" id="step2">
                    ...
                    <div class="form-group">
                        <label for="categorie_id" class="form-label">Catégorie <span style="color: #bf0000;">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="prix" class="form-label">Prix (€) <span style="color: #bf0000;">*</span></label>
                        <input 
                            type="number" 
                            id="prix" 
                            name="prix" 
                ...
                <div class="form-step" id="step3">
                    ...
                    <div class="form-group">
                        <label class="form-label">Photos du produit <span style="color: #bf0000;">*</span></label>
                ...
                <div class="form-step" id="step4">
                    ...
                    <div class="form-group">
                        <label class="form-label">Variantes de produit (Tailles, Couleurs, etc.)</label>
                        <p style="font-size: 0.85rem; color: #666; margin-bottom: 1rem;">
                            Ajoutez des variantes si votre produit est disponible en différentes tailles, couleurs ou matières.
                        </p>
                        
                        <div id="variantsContainer" style="display: flex; flex-direction: column; gap: 1rem; margin-bottom: 1.5rem;">
                            <!-- Les variantes seront ajoutées ici -->
                        </div>
                        
                        <button type="button" class="btn btn-secondary" style="width: 100%; border: 1px dashed #bf0000; background: #fff; color: #bf0000; font-weight: bold;" onclick="addVariant()">
                ...
                <div class="form-step" id="step5">
                    ...
                    <div class="form-group">
                        ...
                        <select id="type_livraison" name="type_livraison" class="form-input">
                            ...
                            <option value="retrait">Retrait sur place uniquement</option>
                            <option value="les_deux">Les deux (livraison et retrait)</option>
                        </select>
                        <small style="color: #666; font-size: 0.875rem; margin-top: 0.5rem; display: block;">
                ...
                <div class="form-step" id="step6">
                    ...
                    <div class="form-group">
                        ...
                        <select id="statut" name="statut" class="form-input">
                            <option value="brouillon" selected>Enregistrer en brouillon</option>
    ...
    <script>
        ...
        function addVariant() {
            ...
            const variantHtml = `
                <div class="variant-item" id="variant_${variantId}" style="background: #fdf2f2; padding: 1rem; border-radius: 8px; border: 1px solid #ffcccc; position: relative;">
                    <button type="button" onclick="removeVariant(${variantId})" style="position: absolute; top: 0.5rem; right: 0.5rem; background: none; border: none; font-size: 1.25rem; color: #bf0000; cursor: pointer;">&times;</button>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 0.5rem;">
                        <div>
                            <label style="font-size: 0.8rem; font-weight: bold; display: block; margin-bottom: 2px;">Type</label>
                            <select name="variantes[${variantId}][type]" class="form-input" style="padding: 0.5rem;">
                        ...
                        <div>
                            <label style="font-size: 0.8rem; font-weight: bold; display: block; margin-bottom: 2px;">Valeur</label>
                            <input type="text" name="variantes[${variantId}][valeur]" class="form-input" style="padding: 0.5rem;" placeholder="Ex: XL, Rouge...">
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div>
                            <label style="font-size: 0.8rem; font-weight: bold; display: block; margin-bottom: 2px;">Stock</label>
                            <input type="number" name="variantes[${variantId}][stock]" class="form-input" style="padding: 0.5rem;" value="1" min="0">
                        </div>
                        <div>
                            <label style="font-size: 0.8rem; font-weight: bold; display: block; margin-bottom: 2px;">Prix sup. (€)</label>
                            <input type="number" name="variantes[${variantId}][prix_supplementaire]" class="form-input" style="padding: 0.5rem;" value="0" step="0.01" min="0">
                        </div>
                    </div>
                </div>
            `;
