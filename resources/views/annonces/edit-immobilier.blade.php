        ...
        <form id="editImmobilierForm" action="{{ route('annonces.update', $annonce) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-step" id="step4">
                ...
                <div style="margin-bottom: 2rem;">
                    ...
                    <p class="instruction-text" style="color: #666; font-size: 0.95rem;">Mettez votre bien en avant pour toucher plus d'acheteurs potentiels.</p>
                </div>
...
<script>
    ...
    function updatePromoPreview() {
        ...
        // In immobilier, we might have prix_vente or loyer_mensuel
        const typeTrans = document.getElementById('type_transaction').value;
        const valInput = (typeTrans === 'vente') ? document.querySelector('input[name="prix_vente"]') : document.querySelector('input[name="loyer_mensuel"]');
    ...
    document.querySelectorAll('input[name="prix_vente"], input[name="loyer_mensuel"]').forEach(input => {
    ...
    document.getElementById('editImmobilierForm').addEventListener('submit', function (e) {
        const statut = document.querySelector('input[name="statut"]:checked').value;
        if (statut === 'publiee') {
