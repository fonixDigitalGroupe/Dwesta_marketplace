...
<div class="rakuten-page">
    ...
    <div class="rk-sponsor-section" style="background: #fff; padding: 3rem 1rem 2rem 1rem; max-width: 1280px; width: calc(100% - 80px); margin: 1.5rem auto 0 auto; border-radius: 8px;">
    ...
    <div style="background: #fff; padding: 2rem 1rem 3rem 1rem; max-width: 1280px; width: calc(100% - 80px); margin: 1.5rem auto 0 auto; border-radius: 8px;">
