        ...
        <div class="register-card">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input type="text" name="prenom" placeholder="Prénom" class="form-input-box"
                ...
                <div class="form-group">
                    <input type="text" name="nationalite" placeholder="Nationalité" class="form-input-box" value="{{ old('nationalite') }}"
                        required>
                    @error('nationalite')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    <input type="tel" name="telephone" placeholder="Téléphone"
                        class="form-input-box" value="{{ old('telephone') }}" required>
                    @error('telephone')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <input type="email" name="email" placeholder="E-mail" class="form-input-box"
                ...
                <div class="form-group">
                    <textarea name="adresse" placeholder="Adresse complète" class="form-input-box" style="height: 100px; resize: vertical;" required>{{ old('adresse') }}</textarea>
                    @error('adresse')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
