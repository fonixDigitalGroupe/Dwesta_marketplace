...
<div style="max-width: 800px; margin: 2rem auto; padding: 0 1rem;">
    <div style="background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); padding: 2rem;">
        ...
        <form method="POST" action="{{ route('avis.store', $annonce) }}" enctype="multipart/form-data">
            ...
            <!-- Note (étoiles) -->
            <div style="margin-bottom: 2rem;">
                <label style="display: block; margin-bottom: 0.75rem; color: #333; font-weight: 500; font-size: 1.125rem;">
                ...
                <div style="display: flex; gap: 0.5rem; align-items: center;">
                    @for($i = 5; $i >= 1; $i--)
                        <label style="cursor: pointer;">
                            ...
                            <span class="star-rating" data-rating="{{ $i }}" style="font-size: 2.5rem; color: #ddd; transition: color 0.2s;">★</span>
                        </label>
                    @endfor
            ...
            <!-- Commentaire -->
            <div style="margin-bottom: 2rem;">
                <label for="commentaire" style="display: block; margin-bottom: 0.75rem; color: #333; font-weight: 500; font-size: 1.125rem;">
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <small style="color: #666; font-size: 0.875rem; display: block; margin-top: 0.5rem;">
                    Formats acceptés : JPG, PNG, WEBP. Taille maximale : 2 Mo par photo. Maximum 3 photos.
                </small>
                @error('photos.*')
                    <span style="color: #EF3B2D; font-size: 0.875rem; margin-top: 0.5rem; display: block;">{{ $message }}</span>
                @enderror
            ...
            <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                <a href="{{ route('annonces.show', $annonce) }}" style="display: inline-block; background: #6c757d; color: white; padding: 0.75rem 1.5rem; text-decoration: none; border-radius: 4px; font-weight: 500;">
                    Annuler
                </a>
                <button type="submit" style="background: #EF3B2D; color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 4px; font-weight: 500; font-size: 1rem; cursor: pointer;">
                    Publier mon avis
                </button>
            </div>
        </form>
