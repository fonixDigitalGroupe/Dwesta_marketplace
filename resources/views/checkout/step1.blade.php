...
<style>
    ...
    .express-text span { color: var(--jumia-orange); }
...
<div class="checkout-wrapper">
    <div class="checkout-left">
        ...
        <div class="box">
            <div class="box-header" style="background: #fff; padding: 12px 16px; border-bottom: 1px solid #eee;">
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <span style="display: flex; align-items: center; gap: 10px; color: #313133; font-size: 13px; font-weight: 700; text-transform: uppercase;">
                        <span style="width: 20px; height: 20px; border-radius: 50%; background: #4caf50; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700;">
                            <i class="fas fa-check"></i>
                        </span>
                        1. ADRESSE CLIENT
                    </span>
                    <a href="{{ route('profile.show') }}" class="modifier-link" style="color: #004aad; font-size: 13px; font-weight: 700; text-decoration: none;">Modifier &gt;</a>
                </div>
            </div>
            <div class="box-body" style="padding: 16px;">
                <div class="summary-section-header" style="font-weight: 700; font-size: 16px; color: #313133;">Adresse de livraison</div>
                <div class="summary-section-subtitle" style="font-size: 13px; color: #666; margin-bottom: 12px;">Votre colis sera expédié à cette adresse</div>
        ...
        <div class="box" id="box-delivery">
            ...
            <div class="box-header" id="delivery-header-done" style="display: none; background: #fff; padding: 12px 16px; cursor: pointer; border-bottom: 1px solid #eee;" onclick="editDelivery()">
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <span style="display: flex; align-items: center; gap: 10px; color: #313133; font-size: 13px; font-weight: 700; text-transform: uppercase;">
                        <span style="width: 20px; height: 20px; border-radius: 50%; background: #4caf50; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700;">
                            <i class="fas fa-check"></i>
                    ...
                    <a href="#" class="modifier-link" style="color: #004aad; font-size: 13px; font-weight: 700; text-decoration: none;">Modifier &gt;</a>
                </div>
            </div>
            <div class="box-body">
                <form action="{{ route('checkout.process') }}" method="POST" id="deliveryForm">
                    ...
                    <div class="delivery-option">
                        <label class="option-label" style="display: flex; align-items: center; cursor: pointer;">
                            <input type="radio" name="mode_livraison" value="retrait_point_relais" class="option-radio" id="radio-pr" {{ $requiresPointRelais ? 'checked' : '' }} onchange="toggleDeliveryOptions()">
                            <span class="option-title" style="margin-left: 10px; font-size: 16px; display: flex; align-items: center;">
                                Point Relais 
                                <span class="option-price" id="price-pr-badge" style="display: none;">À PARTIR DE <span id="price-pr"></span></span>
                            </span>
                        </label>
                        <div class="option-date" id="date-pr" style="margin-left: 32px; color: #313133; font-size: 14px; margin-top: 4px;">Calcul en cours...</div>
                        
                        <div id="pr-selection-area" style="display: {{ $requiresPointRelais ? 'block' : 'none' }};">
                            <div class="sub-box">
                                <div class="sub-box-header">
                                    Point Relais
                                    <a href="#" class="modifier-link" id="btn-choose-pr">Choisissez un point relais ></a>
                                </div>
                                <div class="sub-box-body" id="pr-status-box">
                                    <div style="width: 40px; height: 40px; background: #fff3e0; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: var(--jumia-orange);">
                                        <i class="fas fa-map-marker-alt"></i>
                                    </div>
                                    <div style="font-size: 13px;">
                                        <strong id="pr-selected-name" style="display: block; color: var(--jumia-text);">Point relais non sélectionné</strong>
                                        <span id="pr-selected-addr" style="color: #999;">Veuillez choisir un point relais proche de votre emplacement...</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="delivery-option">
                        <label class="option-label" style="display: flex; align-items: center; cursor: pointer;">
                            <input type="radio" name="mode_livraison" value="livraison_domicile" class="option-radio" id="radio-domicile" {{ !$requiresPointRelais ? 'checked' : '' }} onchange="toggleDeliveryOptions()">
                            <span class="option-title" style="margin-left: 10px; font-size: 16px; display: flex; align-items: center;">
                                Livraison à domicile 
                                <span class="option-price" id="price-domicile-badge" style="display: inline-block;">À PARTIR DE <span id="price-domicile"></span></span>
                            </span>
                            <i class="fas fa-truck" style="margin-left: auto; color: #f68b1e;"></i>
                        </label>
                        <div class="option-date" id="date-domicile" style="margin-left: 32px; color: #313133; font-size: 14px; margin-top: 4px;">Calcul en cours...</div>

                        <div id="domicile-details-area" style="display: {{ !$requiresPointRelais ? 'block' : 'none' }}; margin-top: 16px;">
                    ...
                    <div style="padding: 16px 0 4px; text-align: right;">
                        <button type="button" onclick="confirmDelivery()" id="btn-confirm-delivery" class="btn-confirm-delivery" style="background: #ff9900; color: #fff; border: none; padding: 10px 22px; border-radius: 4px; font-weight: 700; font-size: 14px; cursor: pointer; transition: opacity 0.2s;">
                ...
                <div id="delivery-summary" style="display: none;">
                    <!-- Domicile Block -->
                    <div id="summary-domicile-block" class="summary-shipment-card" style="display: none; margin-bottom: 8px;">
                    ...
                    <div id="summary-pr-block" class="summary-shipment-card" style="display: none; margin-bottom: 8px;">
                        ...
                        <div id="summary-pr-name" style="font-size: 13px; font-weight: 700; color: #313133; margin-bottom: 2px;"></div>
                        <div id="summary-pr-addr" style="font-size: 12px; color: #666; line-height: 1.4; margin-bottom: 6px;"></div>
        ...
        <!-- 3. MODE DE PAIEMENT -->
        <div class="box" id="box-payment" style="opacity: 0.5; pointer-events: none; border: 1px solid #eee; border-radius: 4px; overflow: hidden; background: #fff;">
            <!-- Inactive/Active Header -->
            <div class="box-header" id="payment-header" style="background: #fff; padding: 12px 16px; border-bottom: 1px solid #eee;">
                <span id="payment-header-text" style="display: flex; align-items: center; gap: 10px; color: #313133; font-size: 13px; font-weight: 700; text-transform: uppercase;">
                    <span id="payment-step-num" style="width: 20px; height: 20px; border-radius: 50%; background: #ccc; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700; flex-shrink: 0;">
                        3
                    </span>
                    3. MODE DE PAIEMENT
                </span>
            ...
            <div class="box-header" id="payment-header-done" style="display: none; background: #fff; padding: 12px 16px; cursor: pointer; border-bottom: 1px solid #eee;" onclick="editPayment()">
                <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                    <span style="display: flex; align-items: center; gap: 10px; color: #313133; font-size: 13px; font-weight: 700; text-transform: uppercase;">
                        <span style="width: 20px; height: 20px; border-radius: 50%; background: #4caf50; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 700;">
                            <i class="fas fa-check"></i>
                    ...
                    <a href="#" class="modifier-link" style="color: #004aad; font-size: 13px; font-weight: 600; text-decoration: none;">Modifier &gt;</a>
                </div>
            </div>
            ...
            <div class="box-body" id="payment-body" style="display: none; padding: 15px 20px;">
                ...
                <div id="payment-summary" style="display: none; padding-top: 10px;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; background: #fff; padding: 5px 0;">
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <div id="summary-payment-name" style="font-weight: 700; color: #313133; font-size: 14px;">Mode de paiement</div>
                            </div>
                    ...
                    <div id="back-to-shop-link" style="display: none; margin-top: 15px; border-top: 1px solid #eee; padding-top: 10px;">
                        <a href="{{ route('home') }}" style="color: #004aad; font-size: 13px; font-weight: 600; text-decoration: none; display: flex; align-items: center; gap: 8px;">
                ...
                <div id="payment-options-list">
                    ...
                    <label class="payment-option-modern" onclick="selectModernPayment(this, 'commande', 'om')">
                        ...
                        <div class="payment-info-wrapper">
                            <div class="payment-title-row">
                                <span class="payment-name">Avec Orange Money <span style="background: #fff0e0; color: #f68b1e; font-size: 11px; font-weight: 800; padding: 3px 8px; border-radius: 3px; margin-left: 5px;">soit un montant total de <span class="payment-total-value">0</span> FCFA</span></span>
                                <div style="margin-left: auto;">
                                    <img src="{{ asset('images/logoOM.png') }}" alt="Orange Money" class="method-logo" style="height: 30px;">
                                </div>
                            </div>
                            <!-- Description en dessous du titre -->
                            <div style="font-size: 13px; color: #666; margin-top: 4px;">Paiement rapide et sécurisé via votre compte Orange Money.</div>
                        </div>
                    </label>
                    ...
                    <label class="payment-option-modern" onclick="selectModernPayment(this, 'commande', 'wave')">
                        ...
                        <div class="payment-info-wrapper">
                            <div class="payment-title-row">
                                <span class="payment-name">Avec Wave <span style="background: #fff0e0; color: #f68b1e; font-size: 11px; font-weight: 800; padding: 3px 8px; border-radius: 3px; margin-left: 5px;">soit un montant total de <span class="payment-total-value">0</span> FCFA</span></span>
                                <div style="margin-left: auto;">
                                    <img src="{{ asset('images/logowave.png') }}" alt="Wave" class="method-logo">
                                </div>
                            </div>
                            <!-- Description en dessous du titre -->
                            <div style="font-size: 13px; color: #666; margin-top: 4px;">Payez instantanément avec l'application Wave mobile.</div>
                        </div>
                    </label>
                    ...
                    <label class="payment-option-modern" onclick="selectModernPayment(this, 'livraison_buyer', '')">
                        ...
                        <div class="payment-info-wrapper">
                            ...
                            <!-- Description en dessous du titre -->
                            <div style="font-size: 13px; color: #666; margin-top: 6px;">Payez dès réception de votre commande à domicile.</div>
                        </div>
                    </label>

                    <div style="margin-top: 40px; display: flex; justify-content: flex-end;">
                        <button type="button" onclick="confirmPayment()" id="btn-confirm-payment" class="btn-confirm-final" style="padding: 10px 22px; font-size: 14px;">
    ...
    <div class="checkout-right">
        <div class="summary-card">
            ...
            <div id="voucher-container" style="margin-top: 15px; border-top: 1px solid #eee; padding-top: 15px; display: none;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <div style="position: relative; flex: 1;">
                        <i class="fas fa-ticket-alt" style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: #999;"></i>
                        <input type="text" id="voucher_code" placeholder="Entrer le code" style="width: 100%; padding: 10px 12px 10px 38px; border: 1px solid #ccc; border-radius: 4px; font-size: 14px; outline: none; transition: border-color 0.2s;" onfocus="this.style.borderColor='#f68b1e'" onblur="this.style.borderColor='#ccc'">
                    </div>
                    <button type="button" onclick="applyVoucher()" style="background: none; border: none; color: #004aad; font-weight: 700; font-size: 13px; cursor: pointer; text-transform: uppercase;">APPLIQUER</button>
                </div>
            </div>
            
            <p id="voucher-placeholder-text" class="voucher-text" style="font-size: 12px; color: #666; margin-top: 12px; padding-top: 12px; border-top: 1px solid #eee;">
            ...
            <button type="button" class="btn-confirm" id="btn-submit" onclick="submitFinal()" style="opacity: 0.5; pointer-events: none;">
            ...
            <div style="margin-top: 16px; font-size: 11px; color: #666; border-top: 1px solid #eee; padding-top: 12px; line-height: 1.4;">
                En validant votre choix, vous acceptez automatiquement les <a href="#" style="color: var(--jumia-blue); text-decoration: none;">Conditions générales d'utilisation</a>
            </div>
        </div>
    </div>
</div>
...
<div id="pr-modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
    <div style="background: white; width: 90%; max-width: 600px; border-radius: 8px; overflow: hidden; display: flex; flex-direction: column; max-height: 80vh;">
        <div style="padding: 16px; border-bottom: 1px solid #eee; display: flex; justify-content: space-between; align-items: center;">
            <strong style="font-size: 18px;">Choisir un point relais</strong>
            <button onclick="closePRModal()" style="background: none; border: none; font-size: 24px; cursor: pointer;">&times;</button>
        </div>
        <div style="overflow-y: auto; padding: 16px;">
            @foreach($pointRelais as $pr)
                <div onclick="selectPoint({{ $pr->id }}, '{{ addslashes($pr->nom) }}', '{{ addslashes($pr->adresse) }}', '{{ $pr->region }}')" style="padding: 12px; border: 1px solid #eee; border-radius: 4px; margin-bottom: 8px; cursor: pointer; transition: background 0.2s;" onmouseover="this.style.background='#f9f9f9'" onmouseout="this.style.background='white'">
                    <div style="font-weight: 700; font-size: 15px;">{{ $pr->nom }}</div>
                    <div style="font-size: 13px; color: #666;">{{ $pr->adresse }}</div>
                    <div style="font-size: 12px; color: var(--jumia-orange); margin-top: 4px; font-weight: 700;" class="pr-fee-display" data-region="{{ $pr->region }}">
                        Calcul en cours...
                    </div>
                </div>
            @endforeach
