...
@section('content')
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div
                style="background: linear-gradient(135deg, #004aad 0%, #002a6b 100%); padding: 1.4rem 1.75rem; border-radius: 16px; margin: 0 auto 1.75rem; border: 1px solid rgba(255,255,255,0.15); box-shadow: 0 10px 20px -10px rgba(0,0,0,0.2); position: relative; overflow: hidden; color: white; max-width: 420px; isolation: isolate;">
