...
<head>
    ...
    <title>@yield('title', 'Livreur') - Karnou</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', Arial, sans-serif; }
        ...
        /* header */
        .top-banner { background-color: #000000; height: 40px; width: 100%; }
        ...
        .search-button { background-color: var(--mady-orange); color: white; border: none; border-radius: 4px; padding: 0 1.25rem; cursor: pointer; display: flex; align-items: center; justify-content: center; }
        .search-button:hover { background-color: var(--mady-orange-hover); }
        ...
        .user-dropdown-item:hover { background-color: #f9f9f9; color: var(--mady-orange); }
        ...
        .btn-pro-primary { background: #1e293b; color: #fff; padding: 10px 20px; border-radius: 4px; font-weight: 700; font-size: 0.9rem; border: none; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 8px; text-decoration: none; }
        .btn-pro-primary:hover { background: #0f172a; color: white; }
...
<body class="h-full">
                ...
                <div class="search-container">
                    <form action="#" method="GET" style="width: 100%;">
                        <div class="search-field">
                            <input type="text" class="search-input" placeholder="Rechercher une livraison, un client..."
                                autocomplete="off">
    ...
    <div class="breadcrumb">
        <a href="{{ route('home') }}">Accueil</a> > <a href="{{ route('livreur.dashboard') }}">Livreur</a>
        @yield('breadcrumbs')
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.delete-form').forEach(form => {
                form.addEventListener('submit', function(e) {
                    e.preventDefault();
                    Swal.fire({
                        title: 'Êtes-vous sûr ?', text: "Cette action est irréversible.", icon: 'warning', showCancelButton: true, confirmButtonColor: '#000', cancelButtonColor: '#d33', confirmButtonText: 'Oui, supprimer', cancelButtonText: 'Annuler',
