...
<head>
    ...
    <title>@yield('title', 'Point Relais') - Karnou</title>
...
<body class="h-full">
                ...
                <div class="search-container">
                    <form action="#" method="GET" style="width: 100%;">
                        <div class="search-field">
                            <input type="text" class="search-input" placeholder="Rechercher un colis..."
                                autocomplete="off">
    ...
    <div class="breadcrumb">
        <a href="{{ route('home') }}">Accueil</a> > <a href="{{ route('relais.dashboard') }}">Point Relais</a>
        @yield('breadcrumbs')
    </div>

    <div class="admin-main">
        @include('layouts.partials.relais-sidebar')
