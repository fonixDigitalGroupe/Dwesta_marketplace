...
@section('title', 'Expédition : Livraison Rapide - Karnou')
...
<div class="legal-page">
    ...
    <div class="legal-layout">
        <aside class="legal-toc">
            ...
            <ul class="toc-list">
                <li><a href="#shp1">1 — Délais de Livraison</a></li>
                <li><a href="#shp2">2 — Suivi de Colis</a></li>
                <li><a href="#shp3">3 — Partenaires Logistiques</a></li>
            </ul>
        </aside>

        <main class="legal-main">
            <article id="shp1" class="legal-article">
                <div class="article-num">01</div>
                <div class="article-body">
                    <h2>Des délais optimisés</h2>
                    <p>Nous travaillons en étroite collaboration avec nos vendeurs pour assurer une expédition sous 24h à 48h après validation de votre commande.</p>
                </div>
            </article>

            <article id="shp2" class="legal-article">
                <div class="article-num">02</div>
                <div class="article-body">
                    <h2>Suivi en temps réel</h2>
                    <p>Dès l'expédition de votre colis, vous recevez un numéro de suivi vous permettant de consulter l'état de votre livraison directement depuis votre compte Karnou.</p>
                </div>
            </article>

            <article id="shp3" class="legal-article">
                <div class="article-num">03</div>
                <div class="article-body">
                    <h2>Réseau de livraison étendu</h2>
                    <p>Que ce soit à domicile, en point relais ou via nos transporteurs partenaires, nous couvrons une large zone géographique pour vous livrer où que vous soyez.</p>
                </div>
            </article>
        </main>
    </div>
