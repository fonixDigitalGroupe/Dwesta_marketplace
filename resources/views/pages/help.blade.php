    ...
    <div class="legal-layout">
        ...
        <main class="legal-main">
            ...
            <div class="legal-contact-strip">
                ...
                <div>
                    <strong>Besoin d'une aide personnalisée ?</strong><br>
                    Notre équipe de support est là pour vous. Écrivez-nous à <a href="mailto:support@karnou.com">support@karnou.com</a>.
                </div>
            </div>
        </main>
    </div>
