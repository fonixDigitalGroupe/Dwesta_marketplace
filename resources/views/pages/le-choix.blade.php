...
@section('title', 'Le Choix : Neuf et Occasion - Karnou')
...
<div class="legal-page">
    ...
    <div class="page-hero" style="background-image: linear-gradient(135deg, rgba(0,74,173,0.88) 0%, rgba(0,30,90,0.82) 100%), url('/images/about_hero_ecommerce.png');">
        <div class="about-container">
            <h1>Le Choix : Neuf et Occasion</h1>
            <p class="page-hero-desc">Explorez un catalogue riche et varié. Chez Karnou, nous rassemblons des milliers d'articles neufs et de seconde main pour répondre à tous vos besoins.</p>
    ...
    <div class="legal-layout">
        <aside class="legal-toc">
            ...
            <ul class="toc-list">
                <li><a href="#choice1">1 — Un catalogue illimité</a></li>
                <li><a href="#choice2">2 — Neuf vs Occasion</a></li>
                <li><a href="#choice3">3 — Engagement durable</a></li>
            </ul>
        </aside>

        <main class="legal-main">
            <article id="choice1" class="legal-article">
                <div class="article-num">01</div>
                <div class="article-body">
                    <h2>Un catalogue illimité</h2>
                    <p>De la mode à la high-tech, de la maison aux loisirs, Karnou vous offre une sélection de produits provenant de vendeurs professionnels et de particuliers passionnés.</p>
                </div>
            </article>

            <article id="choice2" class="legal-article">
                <div class="article-num">02</div>
                <div class="article-body">
                    <h2>Qualité : Neuf ou Occasion ?</h2>
                    <p>Nous facilitons votre recherche en distinguant clairement l'état des produits. Que vous recherchiez le dernier modèle scellé ou une perle rare d'occasion à prix réduit, vous trouverez votre bonheur.</p>
                </div>
            </article>

            <article id="choice3" class="legal-article">
                <div class="article-num">03</div>
                <div class="article-body">
                    <h2>Un engagement pour la durabilité</h2>
                    <p>En favorisant l'achat d'occasion, vous participez à une économie circulaire responsable. Karnou encourage la seconde vie des produits pour réduire notre empreinte environnementale.</p>
                </div>
            </article>
        </main>
    </div>
