...
@section('content')
    <style>
        /* Styles spécifiques pour cette page, en complément du layout */
        .step-header {
            text-align: center;
            margin-bottom: 3rem;
            margin-top: 2rem;
            ...
            <div class="type-selector">
                ...
                <div class="type-card" id="professionnel-card" onclick="selectType('professionnel')">
                    <div class="type-icon">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-10V4m0 10V4m-4 6h4m-4 4h4m1 1H7">
                            </path>
                        </svg>
                    </div>
            ...
            <form action="{{ route('vendeur.store.particulier') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload" onclick="document.getElementById('doc-particulier').click()">
                        ...
                        <input type="file" id="doc-particulier" name="document" style="display: none;"
                            accept=".pdf,.jpg,.jpeg,.png">
                    </div>
                </div>

                <div id="file-name-particulier"
                    style="margin-top: -1rem; margin-bottom: 1.5rem; font-size: 0.85rem; color: #bf0000; font-weight: bold;">
                </div>
            ...
            <form action="{{ route('vendeur.store.professionnel') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nom_entreprise" class="input-field"
                        placeholder="Ex: Boutique Mady Market Bangui" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload" onclick="document.getElementById('doc-pro').click()">
                        ...
                        <p style="font-size: 0.8rem; margin-top: 0.5rem;">PDF, JPG, PNG (Max 5 Mo)</p>
                        <input type="file" id="doc-pro" name="registre_commerce" style="display: none;"
                            accept=".pdf,.jpg,.jpeg,.png">
                    </div>
                </div>

                <div id="file-name-pro"
                    style="margin-top: -1rem; margin-bottom: 1.5rem; font-size: 0.85rem; color: #bf0000; font-weight: bold;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="adresse_entreprise" class="input-field"
                        placeholder="Ex: Avenue Barthélémy Boganda, Bangui">
                </div>
