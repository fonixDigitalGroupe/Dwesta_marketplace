...
<div class="dashboard-container">
    ...
    <main class="main-content">
        ...
        <div class="order-summary-header" style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem;">
            ...
            <a href="{{ route('vendeur.orders.invoice', $order) }}" class="btn-download-invoice" title="Télécharger Bordereau PDF" style="display: inline-flex; align-items: center; justify-content: center; background-color: #6b7280; color: white; width: 42px; height: 42px; border-radius: 4px; text-decoration: none; font-size: 1.1rem; transition: background-color 0.2s;">
