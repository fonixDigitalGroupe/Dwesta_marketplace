                    ...
                    <div class="card-inner">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:flex-end; margin-top:0.1rem;">
                            <div>
                                ...
                                <div
                                    style="font-family:'Courier New',monospace; font-size:0.82rem; letter-spacing:0.12em; opacity:0.9;">
                        ...
                        <tbody>
                            @forelse($recentTransactions as $tx)
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-weight: 700; white-space: nowrap; color: {{ $tx->montant >= 0 ? '#15803d' : '#dc2626' }};">
